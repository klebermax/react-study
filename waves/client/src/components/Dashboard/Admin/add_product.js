...
class AddProduct extends Component {
  ...
  componentDidMount() {
    Promise.all([this.props.getBrands(), this.props.getWoods()]).then(() => {
      let newFormData = this.state.formdata;
      populateOptionFields(newFormData, this.props.products.brands, 'brand');
      populateOptionFields(newFormData, this.props.products.woods, 'wood');
